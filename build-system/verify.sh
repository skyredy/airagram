...
export DEVELOPMENT_CODE_SIGN_IDENTITY="iPhone Distribution: YOUR_ORG_NAME (YOUR_TEAM_ID)"
export DISTRIBUTION_CODE_SIGN_IDENTITY="iPhone Distribution: YOUR_ORG_NAME (YOUR_TEAM_ID)"
